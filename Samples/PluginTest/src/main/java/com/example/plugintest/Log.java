...
public class Log {
    ...
    public static void v(Object... msg) {
        printLog(android.util.Log.VERBOSE, msg);
    }
    ...
    public static void e(Object... msg) {
        printLog(android.util.Log.ERROR, msg);
    }
        ...
        if (isDebug) {
            try {
                ...
                for (StackTraceElement stackTraceElement : sts) {
                    DEFAULT_LOGHANDLER.publish("Log_StackTrace", android.util.Log.ERROR, stackTraceElement.toString());
                }
            } catch (Exception exception) {
                exception.printStackTrace();
            }
    ...
    public static void printException(String msg, Throwable e) {
        if (isDebug) {
            DEFAULT_LOGHANDLER.publish("Log_StackTrace", android.util.Log.ERROR, msg + '\n' + android.util.Log.getStackTraceString(e));
        }
    }
