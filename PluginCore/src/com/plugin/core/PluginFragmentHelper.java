...
public class PluginFragmentHelper {
	...
	private static boolean hackClassLoadForServiceIfNeeded(Intent intent) {
		...
		if (targetClassName != null) {
			...
			if (originalLoader instanceof PluginComponentLoader) {
				...
				PluginComponentLoader newLoader = new PluginComponentLoader("", PluginLoader.getApplicatoin()
	...
	public static class PluginComponentLoader extends DexClassLoader {
		...
		public PluginComponentLoader(String dexPath, String optimizedDirectory, String libraryPath, ClassLoader parent) {
